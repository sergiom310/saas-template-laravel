...
class MetodosPagoAgdController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            'detalle' => 'required|string|max:100|unique:agd_metodo_pago,detalle',
            'activo' => 'boolean'
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            'detalle' => 'required|string|max:100|unique:agd_metodo_pago,detalle,' . $id,
            'activo' => 'boolean'
        ]);
